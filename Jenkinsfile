    ...
    stages {
        ...
        docker {
            ...
            steps {
                ...
                sh label: '', script: 'java -jar /var/jenkins_home/workspace/HelloWorld_master@2/target/scala-2.12/HelloWorld-assembly-0.1.jar'
